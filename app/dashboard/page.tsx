    ...
    return (
      <div className="container mx-auto max-w-6xl px-4 md:px-6 py-10">
        <Alert variant="destructive">
          ...
          <AlertDescription>
            We couldn't retrieve your prescription analysis results. Please try again or contact support.
          </AlertDescription>
        </Alert>
        <div className="mt-4">
      ...
      <div className="grid gap-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Original Prescription</p>
                  <p className="text-sm whitespace-pre-line">
                    {userInfo?.prescription || results.originalPrescription}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Analysis Status</p>
                ...
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Blockchain Record ID</p>
          ...
          <TabsContent value="analysis" className="mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Detailed analysis of your prescription by our AI system</CardDescription>
              </CardHeader>
              <CardContent>
                {results.status !== "valid" && results.issues && results.issues.length > 0 ? (
                  <div className="space-y-4">
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      Our AI analysis found no issues with your prescription. It appears to be valid and appropriate.
                    </AlertDescription>
                  </Alert>
                )}
              </CardContent>
          ...
          <TabsContent value="suggestions" className="mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>AI-generated suggestions based on your prescription and symptoms</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {results.suggestions && results.suggestions.length > 0 ? (
                    results.suggestions.map((suggestion, index) => (
                      <div key={index} className="p-4 border rounded-lg">
                        ...
                        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">{suggestion.description}</p>
                      </div>
                    ))
                  ) : (
          ...
          <TabsContent value="data-sources" className="mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Information about the data sources used in the analysis</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                      The AI system performed {results.dataSources?.searchQueries || "N/A"} search queries to gather
                      additional information from trusted medical sources.
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your prescription analysis is securely stored on the blockchain</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                ...
                <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Record ID</p>
                    <p className="text-sm font-mono">{results.id}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Timestamp</p>
                    <p className="text-sm">{results.timestamp || new Date().toLocaleString()}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm">{results.lastUpdated || new Date().toLocaleString()}</p>
                  </div>
                </div>
              </div>
            </div>
